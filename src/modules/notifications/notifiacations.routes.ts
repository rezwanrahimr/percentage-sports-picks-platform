...
notificationRouter.get("/details/:notificationId", auth(userRole.user), notificationController.viewSpecificNotification);
notificationRouter.put("/status", auth(userRole.user), notificationController.changeNotificationStatus);
notificationRouter.put("/mark-all-read", auth(userRole.user), notificationController.markAllAsRead);
...
notificationRouter.post("/send", auth(userRole.admin), notificationController.sendNotification);
