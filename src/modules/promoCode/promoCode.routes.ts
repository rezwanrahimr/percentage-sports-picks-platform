...
promoCodeRoutes.get('/promo-code/:id', auth(userRole.admin), planController.getPromoCodeById);
promoCodeRoutes.get('/promo-codes', auth(userRole.admin), planController.getPromoCodes);
